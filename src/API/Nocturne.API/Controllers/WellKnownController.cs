    ...
    public ActionResult<OAuthAuthorizationServerMetadata> GetOAuthMetadata()
    {
        ...
        return Ok(
            new OAuthAuthorizationServerMetadata
            {
                ...
                ScopesSupported = new[]
                {
                    OAuthScope.GlucoseRead,
                    OAuthScope.GlucoseReadWrite,
                    OAuthScope.TreatmentsRead,
                    OAuthScope.TreatmentsReadWrite,
                    OAuthScope.DevicesRead,
                    OAuthScope.DevicesReadWrite,
                    OAuthScope.TherapyRead,
                    OAuthScope.TherapyReadWrite,
                    OAuthScope.AlertsRead,
                    OAuthScope.AlertsReadWrite,
